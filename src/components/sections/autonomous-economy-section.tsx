    ...
    <Section id="autonomous-economy" variant="deep">
      <div className="grid items-center gap-12 lg:grid-cols-2">
        <SectionHeader
          ...
          description="The autonomous digital economy represents the next phase of market evolution — systems that verify, decide, and transact with institutional-grade reliability. DICE 2026 is where Africa's architects of this transformation gather to align policy, infrastructure, and capital."
